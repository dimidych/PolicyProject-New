...
{
    public class ActionLogDbContext : DbContext
    {
        public ActionLogDbContext(DbContextOptions<ActionLogDbContext> dbContextOptions) : base(dbContextOptions)
        { }
        ...
        public static readonly ILoggerFactory MyDevelopmentLoggerFactory
            = LoggerFactory.Create(builder => builder
                ...
                .AddProvider(new CustomDevelopmentLoggerProvider("ActionLogDb.log")));
